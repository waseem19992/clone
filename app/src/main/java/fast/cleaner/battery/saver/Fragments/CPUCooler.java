        ...
        public void onReceive(Context context, Intent intent) {
            ...
            try {
                ...
                if (temp >= 30.0) {
                    ...
                    showmain.setTextColor(getResources().getColor(R.color.Yello));
...
//                        getActivity().unregisterReceiver(batteryReceiver);
                                    ...
                                    showmain.setTextColor(getResources().getColor(R.color.BrightBlue));
                                    showsec.setText("CPU Temperature is GOOD");
                                    showsec.setTextColor(getResources().getColor(R.color.BrightBlue));
...
//                                Toast.makeText(getActivity(), "CPU Temperature is Already Normal", Toast.LENGTH_SHORT).show();
                    ...
                    if (Build.VERSION.SDK_INT < 23) {
                        ...
                        showsec.setTextColor(getResources().getColor(R.color.Yello));
